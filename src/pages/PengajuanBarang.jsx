...
import { NAMA_BAGIAN_OPTIONS, NAMA_PEMOHON_OPTIONS } from "../data_helper";
import CustomSelect from "../components/CustomSelect/CustomSelect";
import styles from "./PengajuanBarang.module.css";
  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.card}>
        <h2 className={styles.title}>Form Pengajuan Barang</h2>
        ...
        {loading ? (
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            {barangList.map((item, index) => (
              <div key={item.id} className={styles.barangBlock}>
                <div className={styles.barangHeader}>
                ...
                <div className={styles.barangGrid}>
                  <div>
            ...
            <button
              ...
              disabled={submitLoading}
            >
              {submitLoading ? "Mengirim..." : "Submit Pengajuan"}
            </button>
          </form>
        )}
      </div>
